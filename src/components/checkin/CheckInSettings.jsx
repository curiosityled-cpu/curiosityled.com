...
const TONE_LABELS = {
  ...
  close_friend: "Close-friend candid", // legacy alias
  ...
  return (
    <div className="space-y-4">
          ...
          {editingTone ? (
            ...
            <div className="bg-gray-50 rounded-xl px-4 py-3">
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                ...
                {(tonePref?.tone_mode === 'close_friend_candid' || tonePref?.tone_mode === 'close_friend') && "Atreus talks like a trusted peer who tells you what they really think."}
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-5 pb-5">
          <VisibilityShareFlags userEmail={tonePref?.user_email} />
        </div>
      </div>
