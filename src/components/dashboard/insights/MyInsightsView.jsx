...
export default function MyInsightsView({ user, onMetricsUpdate }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── 2+3. Understanding Your Competencies (with AI summary) ── */}
              ...
              {hasInsight && (
                <div className="space-y-3 pb-4 border-b border-gray-100">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-400">— personalized analysis based on your scores</span>
                  </div>
                    ...
                    {storedInsight.top_strengths?.[0] && (
                      <div className="border border-green-200 rounded-xl p-3 bg-green-50">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-xs font-semibold text-green-800">Top Strength</span>
                        </div>
                    ...
                    {storedInsight.development_areas?.[0] && (
                      <div className="border border-amber-200 rounded-xl p-3 bg-amber-50">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-xs font-semibold text-amber-800">Top Development Priority</span>
                        </div>
                        <p className="text-sm text-amber-700">{storedInsight.development_areas[0]}</p>
                      </div>
                    )}
                    {storedInsight.recommendations?.[0] && (
                      <div className="border border-blue-200 rounded-xl p-3 bg-blue-50 sm:col-span-2">
                        <div className="flex items-center gap-2 mb-1">
                          <Zap className="w-3.5 h-3.5 text-blue-600" />
                          <span className="text-xs font-semibold text-blue-800">Quick Tip</span>
                        </div>
                        <p className="text-sm text-blue-700">{storedInsight.recommendations[0]}</p>
                      </div>
                    )}
                    {storedInsight.risk_flags?.length > 0 && (
                      <div className="border border-gray-200 rounded-xl p-3 bg-gray-50 sm:col-span-2">
                        <div className="flex items-center gap-2 mb-1">
                          <Eye className="w-3.5 h-3.5 text-gray-500" />
                          <span className="text-xs font-semibold text-gray-700">AI Analysis Note</span>
                        </div>
                        <ul className="space-y-1">
