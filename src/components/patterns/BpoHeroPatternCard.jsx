...
import { AlertTriangle, Users, Zap, ArrowRight, TrendingDown, Activity, Maximize2 } from "lucide-react";
        ...
        <CardContent className="p-5">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              size="sm"
              variant="outline"
              className="text-xs font-semibold border-gray-200 text-gray-600 hover:bg-gray-50 gap-1.5"
            >
