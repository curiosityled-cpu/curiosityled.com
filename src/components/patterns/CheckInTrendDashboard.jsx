            ...
            <div className="flex items-center gap-4 p-4 bg-[#0202ff]/5 rounded-xl border border-[#0202ff]/15">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-muted-foreground mt-1">
                  Leadership Index Assessment · {assessment.created_date ? format(parseISO(assessment.created_date), "MMM d, yyyy") : "on file"}
                </p>
              </div>
            </div>
                    ...
                    content={({ active, payload }) => {
                      ...
                      return (
                        <div className="bg-card border border-border rounded-xl px-3 py-2 shadow-lg text-xs">
                          ...
                          <p className="text-[#0202ff] font-bold">{d.score}%</p>
                        </div>
                      );
                    }}
                  />
