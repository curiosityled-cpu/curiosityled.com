          ...
          <TabsContent value="privacy-visibility">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  { label: 'Privacy Training', value: privacyData?.trainingCompleted ? 'Complete' : 'Pending', icon: CheckCircle2, bg: 'bg-green-100', color: 'text-green-600' },
                  { label: 'Data Access', value: 'Monitored', icon: Eye, bg: 'bg-blue-100', color: 'text-blue-600' },
                  { label: 'Encryption', value: 'Active', icon: Shield, bg: 'bg-purple-100', color: 'text-purple-600' },
                  ...
                  <Card key={label}>
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div><p className="text-sm text-gray-600">{label}</p><p className="text-xl font-bold text-gray-900">{value}</p></div>
                      </div>
                    </CardContent>
                  </Card>
                ))}
              ...
              <Card>
                <CardHeader>
                  <CardTitle>What Your Org Sees</CardTitle>
              ...
              {/* Visibility share flags */}
              <Card>
                <CardHeader>
                  <CardTitle>Sharing Controls</CardTitle>
                  <p className="text-sm text-gray-500">Fine-grained control over what's shared more broadly.</p>
                </CardHeader>
                <CardContent>
